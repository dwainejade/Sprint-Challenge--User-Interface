...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
 - code that is easy to understand and makes sense to tge reader.
2. What are the 4 areas of the box model?
    - 
3. While using flexbox, what axis does the following property work on: ```align-items: center```?
    - the cross axis
4. Explain why git is valuable to a team of developers.
    - it allows many memeber to build on the same product simultaneously by creating branches from the working product and eventually merging the changes back when completed.
5. Define mobile-first design in your own words.
    - building a website that works great on mobile first then building it out for tablets and desktops by adding in other features.
